...
import {SurfaceDefinitionTree, SurfaceDefinition, SurfaceAnimation, SurfaceAnimationPattern, SurfaceCollision} from "ikagaka-shell-loader/lib/Model/SurfaceDefinitionTree";
import {SurfaceModel, Seriko, SurfaceRenderingTree, SurfaceRenderingLayerSet, SurfaceRenderingLayer} from "../Model/SurfaceModel";
...
function layersToTree(surfaces: SurfaceDefinition[], scopeId: number, n: number, serikos: {[a:number]:Seriko}, config: Config): SurfaceRenderingTree {
